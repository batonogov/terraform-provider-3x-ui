...
**سیاست پشتیبانی:** این provider به‌طور رسمی از چهار خط مینور 3x-ui پشتیبانی می‌کند: **2.9.x**، **3.0.x**، **3.1.x** و **3.2.x** — هر patch منتشرشده از هر چهار خط در هر push به `main` و هر pull request توسط ماتریس acceptance اجرا می‌شود.
