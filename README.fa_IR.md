...
**سیاست پشتیبانی:** این provider به‌طور رسمی از پنج خط مینور 3x-ui پشتیبانی می‌کند: **v3.1.x**، **v3.2.x**، **v3.3.x**، **v3.4.x** و **v3.5.x** — هر patch منتشرشده از هر پنج خط در هر push به `main` و هر pull request توسط ماتریس acceptance اجرا می‌شود.
