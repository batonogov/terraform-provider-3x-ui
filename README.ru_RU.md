...
**Политика поддержки:** провайдер официально поддерживает пять минорных веток 3x-ui: **v3.1.x**, **v3.2.x**, **v3.3.x**, **v3.4.x** и **v3.5.x** — каждый выпущенный патч всех пяти веток гоняется в acceptance-матрице на каждом push в `main` и на каждом pull request.
